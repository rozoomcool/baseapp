...
MessageEntity _messageEntityDeserialize(
  ...
  object.id = id;
  object.recipient = reader.readStringOrNull(offsets[2]);
...
extension MessageEntityQuerySortBy
  ...
  QueryBuilder<MessageEntity, MessageEntity, QAfterSortBy> sortByRecipient() {
    return QueryBuilder.apply(this, (query) {
...
extension MessageEntityQuerySortThenBy
  ...
  QueryBuilder<MessageEntity, MessageEntity, QAfterSortBy> thenByRecipient() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'recipient', Sort.asc);
    });
  }
...
extension MessageEntityQueryWhereDistinct
  ...
  QueryBuilder<MessageEntity, MessageEntity, QDistinct> distinctByRecipient(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension MessageEntityQueryProperty
  ...
  QueryBuilder<MessageEntity, String?, QQueryOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'createdAt');
    });
  }

  QueryBuilder<MessageEntity, String?, QQueryOperations> recipientProperty() {
    return QueryBuilder.apply(this, (query) {
